...
public class PublicTests  extends TestCase {
	...
	/* Test finding "1", "8", "9" in the document "1", "2", "1", "8", "9" */
	@Test
	public void test198in12189() {
		MinimumSnippet m = get(new String[] {"1", "2", "1", "8", "9"}, new String[] {"1", "8", "9"} );
		assertTrue(m.foundAllTerms());
		assertEquals(2, m.getStartingPos());
